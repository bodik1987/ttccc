  ...
  return (
    <Drawer.Root open={isOpen} onOpenChange={onClose}>
      <Drawer.Portal>
        ...
        <Drawer.Content className="bg-white dark:bg-[#242424] rounded-t-xl flex flex-col h-fit fixed bottom-0 left-0 right-0 outline-none z-30 dark:text-app-light">
          <div className="pt-4 bg-white dark:bg-[#242424] rounded-t-xl">
