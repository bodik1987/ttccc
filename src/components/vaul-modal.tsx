  ...
  return (
    <Drawer.Root open={isOpen} onOpenChange={onClose}>
      <Drawer.Portal>
        ...
        <Drawer.Content className="bg-white dark:bg-[#242424] rounded-t-xl flex flex-col fixed bottom-0 left-0 right-0 h-auto outline-none z-30 dark:text-app-light">
